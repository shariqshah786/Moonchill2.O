...
export const About3 = ({
  title = "About Us",
  description = "MoonChill is a passionate team dedicated to creating innovative solutions that empower businesses to thrive in the digital age.",
  ...
  breakout = {
    ...
    alt: "logo",
    title: "Choose the best Plans from moonchill for your Entertainment ",
    description:
  ...
  return (
    <section className="py-32 m-6 ">
      <div className="container mx-auto">
        <div className="mb-14 grid gap-5 text-center md:grid-cols-2 md:text-left">
          <h1 className="ml-10 text-5xl text-white font-semibold">{title}</h1>
      ...
      <div className=" m-10">
        <h1 className="text-center text-black font-bold">Testimonails</h1>
        <TestimonialsColumn
          testimonials={[
            {
              text: "MoonChill transformed our streaming experience!",
              image: "https://randomuser.me/api/portraits/men/32.jpg",
              name: "John Doe",
              role: "CTO, MediaCorp",
            },
            {
              text: "Loved the UI and content recommendations.",
              image: "https://randomuser.me/api/portraits/women/44.jpg",
              name: "Jane Smith",
              role: "Product Manager, Streamify",
            },
            {
              text: "Loved the UI and content recommendations.",
              image: "https://randomuser.me/api/portraits/women/44.jpg",
